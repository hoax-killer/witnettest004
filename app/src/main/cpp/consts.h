...
const array<ValueName, 79> LogPacketTypeID_To_Name = {{
    {CDMA_Paging_Channel_Message,                       "CDMA_Paging_Channel_Message"},
    {_1xEV_Connection_Attempt,                          "1xEV_Connection_Attempt"},
    {_1xEV_Connection_Release,                          "1xEV_Connection_Release"},
    ...
    {_1xEV_Connected_State_Search_Info,                 "1xEV_Connected_State_Search_Info"},
    {Srch_TNG_1x_Searcher_Dump,                         "Srch_TNG_1x_Searcher_Dump"},
    {_1xEV_Rx_Partial_MultiRLP_Packet,                  "1xEV_Rx_Partial_MultiRLP_Packet"},
    {_1xEVDO_Multi_Carrier_Pilot_Sets,                  "_1xEVDO_Multi_Carrier_Pilot_Sets"},
    {HDR_Pilot_Sets,                                    "HDR_Pilot_Sets"},

    {WCDMA_Search_Cell_Reselection_Rank,                "WCDMA_Search_Cell_Reselection_Rank"},
    {WCDMA_RRC_States,                                  "WCDMA_RRC_States"},
    {WCDMA_CELL_ID,                                     "WCDMA_RRC_Serv_Cell_Info"},
    {WCDMA_Signaling_Messages,                          "WCDMA_RRC_OTA_Packet"},

    {UMTS_NAS_GMM_State,                                 "UMTS_NAS_GMM_State"},
    {UMTS_NAS_MM_State,                                  "UMTS_NAS_MM_State"},
    {UMTS_NAS_MM_REG_State,                              "UMTS_NAS_MM_REG_State"},
    {UMTS_NAS_OTA,                                       "UMTS_NAS_OTA_Packet"},

    {LTE_RRC_OTA_Packet,                                 "LTE_RRC_OTA_Packet"},
    {LTE_RRC_MIB_Message_Log_Packet,                     "LTE_RRC_MIB_Packet"},
    {LTE_RRC_MIB_Message_Log_Packet,                     "LTE_RRC_MIB_Message_Log_Packet"},
    {LTE_RRC_Serv_Cell_Info_Log_Packet,                  "LTE_RRC_Serv_Cell_Info"},

    {LTE_NAS_ESM_Plain_OTA_Incoming_Message,             "LTE_NAS_ESM_OTA_Incoming_Packet"},
    {LTE_NAS_ESM_Plain_OTA_Outgoing_Message,             "LTE_NAS_ESM_OTA_Outgoing_Packet"},
    {LTE_NAS_EMM_Plain_OTA_Incoming_Message,             "LTE_NAS_EMM_OTA_Incoming_Packet"},
    {LTE_NAS_EMM_Plain_OTA_Outgoing_Message,             "LTE_NAS_EMM_OTA_Outgoing_Packet"},
    {LTE_NAS_EMM_State,                                  "LTE_NAS_EMM_State"},
    {LTE_NAS_ESM_State,                                  "LTE_NAS_ESM_State"},

    {LTE_PDCP_DL_Config,                                 "LTE_PDCP_DL_Config"},
    {LTE_PDCP_UL_Config,                                 "LTE_PDCP_UL_Config"},
    {LTE_PDCP_UL_Data_PDU,                               "LTE_PDCP_UL_Data_PDU"},
    {LTE_PDCP_DL_Ctrl_PDU,                               "LTE_PDCP_DL_Ctrl_PDU"},
    {LTE_PDCP_UL_Ctrl_PDU,                               "LTE_PDCP_UL_Ctrl_PDU"},
    {LTE_PDCP_DL_Cipher_Data_PDU,                        "LTE_PDCP_DL_Cipher_Data_PDU"},
    {LTE_PDCP_UL_Cipher_Data_PDU,                        "LTE_PDCP_UL_Cipher_Data_PDU"},
    {LTE_PDCP_DL_Stats,                                  "LTE_PDCP_DL_Stats"},
    {LTE_PDCP_UL_Stats,                                  "LTE_PDCP_UL_Stats"},
    {LTE_PDCP_DL_SRB_Integrity_Data_PDU,                 "LTE_PDCP_DL_SRB_Integrity_Data_PDU"},
    {LTE_PDCP_UL_SRB_Integrity_Data_PDU,                 "LTE_PDCP_UL_SRB_Integrity_Data_PDU"},

    {LTE_MAC_Configuration,                              "LTE_MAC_Configuration"},
    {LTE_MAC_Rach_Trigger,                               "LTE_MAC_Rach_Trigger"},
    {LTE_MAC_Rach_Attempt,                               "LTE_MAC_Rach_Attempt"},
    {LTE_MAC_UL_Transport_Block,                         "LTE_MAC_UL_Transport_Block"},
    {LTE_MAC_DL_Transport_Block,                         "LTE_MAC_DL_Transport_Block"},
    {LTE_MAC_UL_Buffer_Status_Internal,                  "LTE_MAC_UL_Buffer_Status_Internal"},
    {LTE_MAC_UL_Tx_Statistics,                           "LTE_MAC_UL_Tx_Statistics"},

    {LTE_RLC_UL_Config_Log_Packet,                       "LTE_RLC_UL_Config_Log_Packet"},
    {LTE_RLC_DL_Config_Log_Packet,                       "LTE_RLC_DL_Config_Log_Packet"},
    ...
    {LTE_PUCCH_Power_Control,                            "LTE_PHY_PUCCH_Power_Control"},
    {LTE_PUSCH_Power_Control,                            "LTE_PHY_PUSCH_Power_Control"},
    {LTE_PDCCH_PHICH_Indication_Report,                  "LTE_PHY_PDCCH_PHICH_Indication_Report"},
    {LTE_PDSCH_Stat_Indication,                          "LTE_PHY_PDSCH_Stat_Indication"},

    {LTE_PHY_Connected_Mode_LTE_Intra_Freq_Meas_Results, "LTE_PHY_Connected_Mode_Intra_Freq_Meas"},
    {LTE_PHY_CDMA_MEAS,                                  "LTE_PHY_Inter_RAT_CDMA_Measurement"},
    {LTE_PHY_IRAT_Measurement_Request,                   "LTE_PHY_Inter_RAT_Measurement"},
    {LTE_PHY_IRAT_MDB,                                   "LTE_PHY_Inter_RAT_Measurement"},
    {LTE_PHY_RLM_Report,                                 "LTE_PHY_RLM_Report"},
    {LTE_PHY_System_Scan_Results,                        "LTE_PHY_System_Scan_Results"},
    {LTE_PHY_Idle_Neighbor_Cell_Meas,                    "LTE_PHY_Idle_Neighbor_Cell_Meas"},
    {LTE_PHY_Serving_Cell_Measurement_Result,            "LTE_PHY_Serv_Cell_Measurement"},
    {LTE_PHY_Connected_Mode_Neighbor_Meas_Req_Resp,      "LTE_PHY_Connected_Mode_Neighbor_Measurement"},
    {LTE_PHY_CDRX_Events_Info,                           "LTE_RRC_CDRX_Events_Info"},
    {LTE_PHY_BPLMN_Cell_Request,                         "LTE_PHY_BPLMN_Cell_Request"},
    {LTE_PHY_BPLMN_Cell_Confirm,                         "LTE_PHY_BPLMN_Cell_Confirm"},

    {LTE_PHY_Serving_Cell_COM_Loop,                      "LTE_PHY_Serving_Cell_COM_Loop"},
    {LTE_PHY_PDSCH_Demapper_Configuration,               "LTE_PHY_PDSCH_Packet"},
    {LTE_PHY_PDCCH_Decoding_Result,                      "LTE_PHY_PDCCH_Decoding_Result"},
    {LTE_PHY_PDSCH_Decoding_Result,                      "LTE_PHY_PDSCH_Decoding_Result"},
    {LTE_PHY_PUSCH_Tx_Report,                            "LTE_PHY_PUSCH_Tx_Report"},
    {LTE_PHY_PUCCH_Tx_Report,                            "LTE_PHY_PUCCH_Tx_Report"},
    {LTE_PHY_PUCCH_CSF,                                  "LTE_PHY_PUCCH_CSF"},
    {LTE_PHY_PUSCH_CSF,                                  "LTE_PHY_PUSCH_CSF"},

    {GSM_Surround_Cell_BA_List,                          "GSM_Surround_Cell_BA_List"},
    {GSM_RR_Cell_Selection_Parameters,                   "GSM_RR_Cell_Selection_Parameters"},
    {GSM_RR_Cell_Information,                            "GSM_RR_Cell_Information"},
    {GSM_RR_Cell_Reselection_Meas,                       "GSM_RR_Cell_Reselection_Meas"},

    {Modem_debug_message,                                 "Modem_debug_message"}
 }};
